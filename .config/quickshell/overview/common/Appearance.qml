...
Singleton {
    ...
    // Tried to manually modify; didn't work out. Leaving here for reference and potential future use.
    property QtObject defaultColors: QtObject {
        property bool darkmode: true
        property color m3primary: "#58a6ff"
        property color m3onPrimary: "#010409"
        property color m3primaryContainer: '#051024'
        property color m3onPrimaryContainer: '#8bc1fd'
        property color m3secondary: "#bc8cff"
        property color m3onSecondary: "#010409"
        property color m3secondaryContainer: "#051024"
        property color m3onSecondaryContainer: '#d5bff3'
        property color m3background: "#010409"
        property color m3onBackground: "#c9d1d9"
        property color m3surface: "#010409"
        property color m3surfaceContainerLow: '#051024'
        property color m3surfaceContainer: "#484f58"
        property color m3surfaceContainerHigh: "#484f58"
        property color m3surfaceContainerHighest: "#b1bac4"
        property color m3onSurface: "#c9d1d9"
        property color m3surfaceVariant: "#161b22"
        property color m3onSurfaceVariant: "#8b949e"
        property color m3inverseSurface: "#c9d1d9"
        property color m3inverseOnSurface: "#21262d"
        property color m3outline: "#30363d"
        property color m3outlineVariant: '#242c35'
        property color m3shadow: "#010409"
    }
